...
The service will run locally at [http://127.0.0.1:8000](http://127.0.0.1:8000). You can access interactive documentation at [http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs).
